---
title: '5bis.Chen 2021 (Tumor Tissue, epithelial cells only) : cell cycle annotation'
...
out_path = create_exp_folder(
  ...
  exp = "5bis_cycle_annotation_tumor_cells"
)
...
file_path = get_exp_file_path(
  github_dir = github_dir,
  samples_ID = "Chen_Tissue",
  prev_exp = "4bis_dimension_reduction_tumor_cells", 
...
```{r Keep only epithelial cells in list_sce object}
...
for (sce in list_sce) {
  ...
  common_cells = which(colnames(sce) %in% colnames(sce_comb))
