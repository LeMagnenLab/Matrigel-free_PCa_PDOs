...
write.csv(colData_table, 
          file = paste0(out_path, "Chen_Tissue_metadata.csv"),
...
saveRDS(
  object = sce_comb,
  file = paste0(out_path,"Chen_Tissue_sce_final.rds"))
...
saveRDS(
  object = seurat_comb,
  file  = paste0(out_path,"Chen_Tissue_seurat_final.rds")
)
