---
title: '2. Atlas PCa PDOS + tissue (tumor only) from Song, Hirz, Chen dataset: dataset rescaling and normalization'
...
file_path = get_exp_file_path(
  ...
  pattern = "list_all_sce_restricted_comb_harmonized")
...
for(sce_id in 1:length(list_sce)){
  ...
  sample = unique(list_sce[[sce_id]]$Sample_Name),
...
saveRDS(
  ...
  file = paste0(out_path,time_stamp(), "list_sce_restricted_normalized_rescaled.rds"))

# Export sce_comb object
saveRDS(
  object = sce_comb_rescaled,
  file = paste0(out_path,time_stamp(),"sce_comb_restricted_normalized_rescaled.rds"))
