...
source(file = "/scicore/home/wykopa75/GROUP/rparmentier/sc_RNAseq/my_R_functions/Dolgos_2024_Custom_Color_Palettes.R")
...
write.csv(colData_table, 
          file = paste0(out_path, "Song_PDOs_metadata.csv"),
...
saveRDS(
  object = sce_comb,
  file = paste0(out_path,"Song_PDOs_sce_final.rds"))
...
saveRDS(
  object = seurat_comb,
  file  = paste0(out_path,"Song_PDOs_final.rds")
)
