---
title: '2.Dolgos early passage PDOs : dimension reduction'
...
```{r Single UMAP colored culture condition = Fig3.A}
...
plot <- ggplot() +
  ...
  dpi = 300, scale = 1) +
  scale_fill_manual(values = pal_conditions) +
  theme_classic() +
    guides(
      alpha = "none",
      size = "none"
...
```{r Single UMAP colored sample = Sup.Fig3.A}
...
ggsave(
  plot = plot,
  filename = paste0(out_path,time_stamp(),"plot_UMAP_Single_Sample.pdf"),
  device = "pdf",
  width = 12,
  height = 8,
)
