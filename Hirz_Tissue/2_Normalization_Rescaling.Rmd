---
title: 'Hirz_2022 : normalization and rescaling'
author: "Romuald Parmentier"
date: "2024-11-15"
output: html_document
---

Warning: uses a lot of RAM, 240Gb session is necessary
...
file_path = get_exp_file_path(
  ...
  project = "Medium_Optimization",
  samples_ID = "Hirz_2022",
  prev_exp = "harmonization_annotation", 
  pattern = "list_sce_harmonized_annotated.rds")
...
for(sce_id in 1:length(list_sce)){
  ...
  sample = unique(list_sce[[sce_id]]$Sample_ID),
