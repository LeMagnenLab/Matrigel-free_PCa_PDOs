...
file_path = get_exp_file_path(
  ...
  pattern = "sce_cycle_annotated.rds" # Sce after batch correction for visualization
)
...
write.csv(colData_table, 
          file = paste0(out_path, "McCray_2019_metadata.csv"),
...
saveRDS(
  object = sce_comb,
  file = paste0(out_path,"McCray_2019_sce_final.rds"))
...
saveRDS(
  object = seurat_comb,
  file  = paste0(out_path,"McCray_2019_seurat_final.rds")
)
...
projections = projections[which(names(projections) == c("UMAP_on_PCA.1.20"))]
