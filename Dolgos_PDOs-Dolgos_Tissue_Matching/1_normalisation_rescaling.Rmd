---
title: '1.Dolgos patient matching tissue & PDOs: normalisation and rescaling'
...
file_path = get_exp_file_path(
  organ = "Prostate",
  project = "Organoids_Atlas",
  samples_ID = "Dolgos_PDOs-Dolgos_Tissue",
...
```{r Keep only early_passage organoids}

# List samples for which tumor and PDOs are available
matching_samples = c("P24-06_PAR_Tum" ,"P24-06_Org_ECMf", "P24-06_Org_Mat", "P24-14_PAR_Tum",  "P24-14_Org_ECMf")

list_sce = lapply(list_sce, function(sce){
  
  if (unique(sce$Sample_Description) %in% matching_samples) {return(sce)} 
  else{return(NULL)}
  
})

list_sce <- list_sce[!sapply(list_sce, is.null)]
