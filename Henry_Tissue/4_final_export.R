...
colData_to_keep <- c(
  "UMAP1", "UMAP2",
  "Sample_Description", "cell_cycle_phase","CellType"
)
...
write.csv(colData_table, 
          file = paste0(out_path, "Henry_2018_metadata.csv"),
...
saveRDS(
  object = sce_comb,
  file = paste0(out_path,"Henry_2018_sce_final.rds"))
...
saveRDS(
  object = seurat_comb,
  file  = paste0(out_path,"Henry_2018_seurat_final.rds")
)
